...
<!--TÍTULO/ÍCONE/DESCRIÇÃO DA PÁGINA/COR TEMA NAVEGADOR-->
    <title>Magister - Resultados</title>
            ...
            <div class="row d-flex justify-content-around">
                    ...
                    <section>
                        <nav>
                            <ul class="ubuntu-regular p-2">
                                ...
                                <li><a href="painel.php"><i class="fa-solid fa-list-check fa-xl"></i><span class="d-none d-md-inline">Atividades</span></a></li>
                                <li><a class="selected" href="painel.php"><i class="fa-solid fa-chart-simple fa-xl"></i><span class="d-none d-md-inline">Resultados</span></a></li>
                ...
                <div id="conteudo-principal" class="col-10 col-md-8 col-lg-9 p-4 border">
                    <section id="atividades">
                        <?php resultadosAtividade($mysqli); ?>              
                    </section>
                </div>
            </div>
        </main>
