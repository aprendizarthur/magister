...
<!--TÍTULO/ÍCONE/DESCRIÇÃO DA PÁGINA/COR TEMA NAVEGADOR-->
    <title>Magister - Erro de Conexão</title>
        ...
        <main>
            <div class="row my-5 d-flex justify-content-center">
                <div id="registro" class="col-11 col-md-6 p-4 border text-center">
                    ...
                    <h1 class="ubuntu-bold texto-azul">Erro de conexão</h1>
                    <p class="ubuntu-regular my-4">Parece que não conseguimos nos conectar ao nosso banco de dados no momento.</p>
